...
import { IMessageSendOptions, ProgramMetadata } from "@gear-js/api";
...
import React from 'react';
    ...
    function CrearProyecto(){
        ...
        let message: IMessageSendOptions;
                        ...
                        <div className="w-full mb-4 border border-gray-800 rounded-lg bg-gray-700 dark:bg-gray-700 dark:border-gray-600">
                            <div className="flex items-center justify-between px-3 py-2 border-b dark:border-gray-600">
                                ...
                                <div className="px-4 py-2 bg-gray-600 rounded-b-lg dark:bg-gray-800">
                                    ...
                                    <textarea id="editor" value={description} onChange={DescriptionInputChange} rows= {8} className="block w-full px-0 text-sm text-gray-800 bg-gray-600 border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..."></textarea>
                                </div>
                            </div>
                            ...
                            <label htmlFor="resp" className="block mb-5 pt-8 text-xl text-green-400 font-bold mt-8">Identificate con tu llave</label>
                            <form className="flex items-center">   
                                <div className="relative w-3/4">
                                    <input type="text" className="bg-gray-600 border border-gray-700 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-600 dark:focus:border-blue-500" placeholder="Key"/>
                                </div>
                                <p className="text-xl text-green-400 font-bold ml-7 mr-7">o</p>
                                <button type="submit" className="flex flex-grow p-2.5 ml-2 text-md font-medium text-gray-800 bg-green-500 justify-center rounded-lg focus:ring-4 focus:outline-none focus:ring-green-600">
                                    llave
                                </button>
                            </form>
                            ...
                            <div className="flex items-start mt-5 gap-6 pb-7">
                                <button type="button"  onClick={handlesaveClick} className="w-1/4 h-10 p-2.5 text-md font-medium text-gray-800 bg-green-500 justify-center rounded-md focus:ring-4 focus:outline-none focus:ring-green-600">
                                        Publicar
                                </button>
